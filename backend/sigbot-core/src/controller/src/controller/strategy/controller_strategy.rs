...
impl SigbotStrategyRunnerController {
    ...
    pub(super) async fn process(&self) {
        info!("Scanning to activate strategies ...");
        // TODO: Implement the logic to scan to activate strategies.
        // TODO: 1. Scan the strategies from the database.
        // TODO: 2. If the strategies is activated, then to start the strategy runner instance(pod/container).
        // TODO: 3. If the strategies is not activated, then to shutdown the strategy runner instance(pod/container).
        unimplemented!()
    }
}
...
impl ISigbotController for SigbotStrategyRunnerController {
    async fn init(&self) {
        ...
        info!("Started Strategy Runner Controller.");
    }

    async fn close(&self) {
        info!(
            "Closing Strategy Runner Controller with cron '{}'",
