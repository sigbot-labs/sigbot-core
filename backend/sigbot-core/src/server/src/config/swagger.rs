...
use sigbot_types::modules::llm::knowledge::KnowledgeUploadInfo;
...
#[openapi(
    info(
        version = "1.0.0",
        title = "SigBot",
        description = "SigBot - A Mini Open Source AI Bot WAF written in Rust.",
    ...
    external_docs(url = "https://github.com/wl4g/sigbot", description = "More about our APIs"),
    paths(
        // Knowledge
