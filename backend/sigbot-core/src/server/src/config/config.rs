...
/// ModSec rules executor based LLM, and similar design as k8s multi specification controller implementation.
#[derive(Debug, Serialize, Deserialize, Clone)]
...
/// ModSec rules generated by LLM to backtest, and similar design as k8s multi specification scheduler implementation.
#[derive(Debug, Serialize, Deserialize, Clone)]
...
impl Default for ServicesProperties {
    fn default() -> Self {
        ServicesProperties {
            ...
            blocked_header_name: String::from("X-SigBot-Blocked"),
