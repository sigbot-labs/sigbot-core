...
pub struct SigbotControllerManager {}

impl SigbotControllerManager {
    pub const COMMAND_NAME: &'static str = "controller-manager";

    pub fn build() -> Command {
        Command::new(Self::COMMAND_NAME).about("Run Sigbot Controller Manager.")
    }
