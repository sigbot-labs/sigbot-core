...
impl WebServer {
    ...
    pub fn build() -> Command {
        Command::new(Self::COMMAND_NAME).about("Run SigBot ModSec proxy Web Server.")
    }
    ...
    pub async fn run(matches: &clap::ArgMatches, verbose: bool) -> () {
        ...
        //     fn(State<SigBotState>, Request<Body>, Next) -> Pin<Box<dyn Future<Output = IntoResponse> + Send + 'static>>,
        // >;
