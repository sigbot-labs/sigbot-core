...
pub struct SigbotDeployerManagerStarter {}

impl SigbotDeployerManagerStarter {
    pub const COMMAND_NAME: &'static str = "deployer";
    ...
    async fn start(matches: &clap::ArgMatches, verbose: bool) {
        SigbotDeployerFactory::startup(matches, verbose).await;
    }
