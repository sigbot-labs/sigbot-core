...
#[derive(Clone)]
pub struct SimpleLLMExecutor {
    config: ExecutorProperties,
    scheduler: Arc<JobScheduler>,
}

impl SimpleLLMExecutor {
...
#[async_trait]
impl ISigBotExecutor for SimpleLLMExecutor {
...
mod tests {
    ...
    //     config.sigbot.analytics.push(analyze_config);
