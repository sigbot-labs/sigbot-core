...
use crate::modules::exchange::route::exchange_router::{
    __path_handle_delete_exchange, __path_handle_query_exchanges, __path_handle_save_exchange,
};
use crate::modules::strategy::route::strategy_router::{
    __path_handle_delete_strategy, __path_handle_query_strategys, __path_handle_save_strategy,
};
use crate::sys::route::user_router::{
    __path_handle_delete_user, __path_handle_get_current_user, __path_handle_post_current_user,
    __path_handle_query_users, __path_handle_save_user,
};
...
#[openapi(
    info(
        version = "1.0.0",
        title = "Sigbot",
        description = "Sigbot - An Open Source Multi-Strategy, AI-driven Fast Trading Bot written in Rust.",
        license(name = "Apache 2.0", url = "https://www.apache.org/licenses/LICENSE-2.0"),
        contact(
            name = "Sigbot",
            url = "https://github.com/wl4g/sigbot",
            email = "jameswong1376@gmail.com"
        )
    ),
    //security((), "my_auth" = ["read:items", "edit:items"], "token_jwt" = []),
    external_docs(url = "https://github.com/wl4g/sigbot", description = "More about Sigbot APIs"),
    paths(
        // System modules
        handle_query_users,
        ...
        // Exchange
        handle_query_exchanges,
        handle_save_exchange,
        handle_delete_exchange,
        // Strategy
        handle_query_strategys,
        handle_save_strategy,
