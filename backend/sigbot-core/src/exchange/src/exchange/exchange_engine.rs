...
lazy_static! {
    static ref SINGLE_INSTANCE: RwLock<SigbotExchangeEngine> = RwLock::new(SigbotExchangeEngine::new());
}
...
impl SigbotExchangeEngine {
    fn new() -> Self {
        SigbotExchangeEngine {
            implementations: HashMap::new(),
        }
    }

    pub fn get() -> &'static RwLock<SigbotExchangeEngine> {
        &SINGLE_INSTANCE
    }
