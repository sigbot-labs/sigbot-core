...
pub struct LedgerInfoSQLiteRepository {
    inner: SQLiteRepository<LedgerInfo>,
}

impl LedgerInfoSQLiteRepository {
    pub async fn new(config: &SqliteAppDBProperties) -> Result<Self, Error> {
        Ok(LedgerInfoSQLiteRepository {
